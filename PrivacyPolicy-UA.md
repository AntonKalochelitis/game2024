...
Ця політика конфіденційності застосовується до додатку Game2048 (надалі "Додаток") для мобільних пристроїв, який був створений Антоном Калочелітісом (надалі "Постачальник послуг") як безкоштовна послуга. Ця послуга призначена для використання "ЯК Є".
